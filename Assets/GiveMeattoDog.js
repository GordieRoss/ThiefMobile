...
if (Input.GetMouseButton(0)&& Inv.gameObject.GetComponent(Inventory).Meat >= 1 && GameObject.Find("DOG").transform.position.z >= GameObject.Find("DogEndPosition").transform.position.z){
